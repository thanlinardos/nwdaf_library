...
public class Regex {
	public static String nf_set_id_plmn = "set[A-Za-z0-9\\-_]+[A-Za-z0-9_]\\.[A-Za-z]+set\\.5gc\\.mnc([0-9]){3}\\.mcc([0-9]){3}";
	public static String nf_set_id_snpn = "set[A-Za-z0-9\\-_]+[A-Za-z0-9_]\\.[A-Za-z]+set\\.5gc\\.nid([A-Za-z0-9]){11}\\.mnc([0-9]){3}\\.mcc([0-9]){3}";
