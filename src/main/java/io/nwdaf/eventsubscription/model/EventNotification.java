...
private Integer rvWaitTime
 = null;
  ...
  @Schema(description = "")
      @Valid
  @Size(min=1)   public List<DispersionInfo> getDisperInfos() {
    return disperInfos;
  }
  ...
  @Schema(description = "")
      @Valid
  @Size(min=1)   public List<RedundantTransmissionExpInfo> getRedTransInfos() {
    return redTransInfos;
  }
  ...
  @Schema(description = "")
      @Valid
  @Size(min=1)   public List<WlanPerformanceInfo> getWlanInfos() {
    return wlanInfos;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(event, start, expiry, timeStampGen, failNotifyCode, rvWaitTime, anaMetaInfo, nfLoadLevelInfos, nsiLoadLevelInfos, sliceLoadLevelInfo, svcExps, qosSustainInfos, ueComms, ueMobs, userDataCongInfos, abnorBehavrs, nwPerfs, dnPerfInfos, disperInfos, redTransInfos, wlanInfos, smccExps);
  }
