...
public class EventReportingRequirement {
	 ...
	 * may be present if the \"listOfAnaSubsets\" attribute is present in the
	 * subscription request when the subscription event is NF_LOAD, UE_COMM,
	...
	@Valid
	@Size(min = 1)
	public List<Accuracy> getAccPerSubset() {
		return accPerSubset;
	}
	 ...
	 * \"repPeriod\" attribute is included within the \"evtReq\" attribute.
	 * 
	 * @return offsetPeriod
	 **/
	...
	@Override
	public int hashCode() {
		return Objects.hash(accuracy, accPerSubset, startTs, endTs, offsetPeriod, sampRatio, maxObjectNbr, maxSupiNbr,
				timeAnaNeeded, anaMeta, anaMetaInd);
	}
