...
public class UserLocation {
	...
	public Map<String, Object> toMap() {
		...
		if (this.eutraLocation != null) {
			map.put("eutraLocation", this.eutraLocation.toMap());
		}
		if (this.n3gaLocation != null) {
			map.put("n3gaLocation", this.n3gaLocation.toMap());
		}
		if (this.nrLocation != null) {
			map.put("nrLocation", this.nrLocation.toMap());
		}
		if (this.utraLocation != null) {
			map.put("utraLocation", this.utraLocation.toMap());
		}
		if (this.geraLocation != null) {
			map.put("geraLocation", this.geraLocation.toMap());
		}
		return map;
	}

	public static UserLocation fromMap(Map<String, Object> map) {
		if (map == null) {
			return null;
		}
		UserLocation result = new UserLocation();
		result.setEutraLocation(EutraLocation.fromMap((Map<String, Object>) map.get("eutraLocation")));
		result.setGeraLocation(GeraLocation.fromMap((Map<String, Object>) map.get("geraLocation")));
		result.setN3gaLocation(N3gaLocation.fromMap((Map<String, Object>) map.get("n3gaLocation")));
		result.setNrLocation(NrLocation.fromMap((Map<String, Object>) map.get("nrLocation")));
		result.setUtraLocation(UtraLocation.fromMap((Map<String, Object>) map.get("utraLocation")));
		return result;
	}
}
