...
public class TransportProtocol {
	...
	public Map<String, Object> toMap() {
		...
		map.put("transportProtocol", ParserUtil.safeParseString(this.transportProtocol));
		return map;
	}

	public static TransportProtocol fromMap(Map<String, Object> map) {
		if(map==null) {
			return null;
		}
		TransportProtocol result = new TransportProtocol();
		result.setTransportProtocol(TransportProtocolEnum.fromValue((String) map.get("transportProtocol")));
		return result;
	}
}
