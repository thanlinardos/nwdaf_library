...
public class EthFlowDescription {
    ...
    public Map<String, Object> toMap() {
        ...
        map.put("destMacAddr", this.destMacAddr);
        map.put("ethType", this.ethType);
        map.put("fDesc", this.fDesc);
        map.put("fDir", this.fDir.toMap());
        map.put("sourceMacAddr", this.sourceMacAddr);
        map.put("vlanTags", this.vlanTags);
        map.put("srcMacAddrEnd", this.srcMacAddrEnd);
        map.put("destMacAddrEnd", this.destMacAddrEnd);

        return map;
    }

    public static EthFlowDescription fromMap(Map<String, Object> map) {
        if (map == null) {
            return null;
        }
        EthFlowDescription result = new EthFlowDescription();
        result.setDestMacAddr((String) map.get("destMacAddr"));
        result.setEthType((String) map.get("ethType"));
        result.setFDesc((String) map.get("fDesc"));
        result.setSourceMacAddr((String) map.get("sourceMacAddr"));
        result.setVlanTags((List<String>) map.get("vlanTags"));
        result.setSrcMacAddrEnd((String) map.get("srcMacAddrEnd"));
        result.setDestMacAddrEnd((String) map.get("destMacAddrEnd"));
        result.setFDir(FlowDirection.fromMap((Map<String,Object>) map.get("fDir")));
        return result;
    }
}
