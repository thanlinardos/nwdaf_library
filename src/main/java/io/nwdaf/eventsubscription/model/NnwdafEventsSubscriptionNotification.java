...
public class NnwdafEventsSubscriptionNotification implements OneOfNnwdafEventsSubscriptionNotification {
    @JsonProperty("id")
    private UUID id;
    @JsonProperty("notificationReference")
    private UUID notificationReference = null;
	...
	public NnwdafEventsSubscriptionNotification id(UUID id) {
		this.id = id;
		return this;
	}

	public UUID getNotificationReference() {
		return notificationReference;
	}

	public void setNotificationReference(UUID notificationReference) {
		this.notificationReference = notificationReference;
	}

	public NnwdafEventsSubscriptionNotification notificationReference(UUID notificationReference) {
		this.notificationReference = notificationReference;
		return this;
	}
    ...
    public Map<String, Object> toMap() {
        ...
        map.put("subscriptionId", this.getSubscriptionId());
        map.put("notifCorrId", this.getNotifCorrId());
        map.put("oldSubscriptionId", this.getOldSubscriptionId());
        return map;
    }
