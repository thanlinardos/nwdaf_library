...
public class ExpectedUeBehaviourData {
	...
	@Override
	public int hashCode() {
		return Objects.hash(stationaryIndication, communicationDurationTime, periodicTime, scheduledCommunicationTime,
				scheduledCommunicationType, expectedUmts, trafficProfile, batteryIndication, validityTime);
	}
